...
/*
 * selene_gamelist.c - Auto-generated game package name table
 */
...
/* Sorted array of game package names */
static const char * const selene_game_names[] = {
...
static int selene_game_cmp(const void *a, const void *b)
{
    const char *key = a;
...
const char *selene_game_lookup(const char *name, unsigned int len)
{
    char **result;
    result = bsearch(name, selene_game_names, SELENE_GAME_COUNT,
                     sizeof(char *), selene_game_cmp);
